(function (i, f, c, k, d, l, h) {
  ...
  var j = (i.$JssorSlider$ = function (p, hc) {
    ...
    if (r) {
      ...
      a.$ArrowKeyNavigation &&
        b.$AddEvent(f, "keydown", function (b) {
    ...
    f.Ec = function (E) {
      if (!u) {
        ...
        for (var f = 0; f < s; f++) {
          ...
          B[f] = l;
          a.$ActionMode & 1 &&
            b.$AddEvent(l, "click", b.$CreateCallback(k, t, f));
          a.$ActionMode & 2 &&
            b.$AddEvent(l, "mouseover", b.Ib(b.$CreateCallback(k, t, f), l));
          y[f] = b.Tb(l);
        }
        u = d;
      }
  ...
  i.$JssorThumbnailNavigator$ = function (g, B) {
    ...
    function A(n, f) {
      ...
      a.$ActionMode & 2 &&
        b.$AddEvent(c, "mouseover", b.Ib(b.$CreateCallback(k, j, 1), c));
    }
    h.wc = function (b, d, f) {
      var a = p;
      p = b;
