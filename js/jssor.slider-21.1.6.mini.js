  ...
  var e = (i.$JssorEasing$ = {
      ...
      $EaseInOutElastic: function (a) {
        ...
        return (a *= 2) < 1
          ...
          : c.pow(2, -10 * (a -= 1)) * c.sin(((a - d) * 2 * c.PI) / b) * 0.5 +
              1;
      },
      ...
      $EaseInOutBounce: function (a) {
        return a < 1 / 2
          ? e.$EaseInBounce(a * 2) * 0.5
          : e.$EaseOutBounce(a * 2 - 1) * 0.5 + 0.5;
      },
  ...
  var b = new (function () {
    ...
    function v(h) {
      if (!s) {
        s = -1;
        if (
          vb == "Microsoft Internet Explorer" &&
          !!i.attachEvent &&
          !!i.ActiveXObject
        ) {
    ...
    g.sc = function (a) {
      ...
      if (a)
        if (b.Zc(a)) c = { jc: c };
        else if (b.Zc(a.$Clip)) c.$Clip = { jc: a.$Clip };
      return c;
    };
    function wb(c, a) {
      var b = {};
  ...
  var j = (i.$JssorSlider$ = function (p, hc) {
    ...
    function Dc() {
      ...
      m.call(
        ...
        -1,
        2,
        { $Easing: e.$EaseLinear, Re: { Cb: bc }, Fc: r },
        b,
        { Cb: 1 },
        { Cb: -2 }
      );
    ...
    var hb = a.$PlayOrientation & 3,
      ...
      I = b.o(
        { $Class: q, $PlayInMode: 1, $PlayOutMode: 1, $HWA: a.$HWA },
  ...
  i.$JssorCaptionSlideo$ = function (n, f, l) {
    ...
    function r(e, f, a) {
      b.a(f, function (h) {
        ...
        var i = { $Easing: g, $OriginalWidth: a.S, $OriginalHeight: a.N },
